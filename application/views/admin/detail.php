                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="callout callout-info">
                                    <h5><i class="far fa-file-alt"></i> Detail laporan Komplain</h5>
                                </div>
                                <!-- Main content -->
                                <div class="invoice p-3 mb-3">
                                    ...
                                    <div class="row invoice-info">
                                        <div class="col-sm-4 invoice-col">
                                            ...
                                            <address>
                                                ...
                                                Register : <?php echo format_indo($detail['date_created']); ?><br>
                                                Status : Aktif<br>
                                            </address>
                                        </div>
                                        <!-- /.col -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <span class="font-weight-bolder mb-2">Foto Komplain : </span>
                                                ...
                                                <div class="col-md-6">
                                                    <span class="font-weight-bolder mb-2">Foto Tanggapan :</span>
